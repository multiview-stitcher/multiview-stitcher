...
### Visualizing tile positions before registration

Before running registration it is useful to sanity-check the input tile layout using `vis_utils.plot_positions`:
