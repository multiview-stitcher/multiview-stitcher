...
# Everything elastix lives in its own module; this keeps the pairwise
# registration function importable from here, next to the other ones.
from multiview_stitcher.elastix import registration_ITKElastix  # noqa: F401
